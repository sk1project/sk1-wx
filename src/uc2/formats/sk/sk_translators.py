...
SK2_ARC_TYPES = {
	sk_const.ArcArc:sk2_const.ARC_ARC,
	sk_const.ArcChord:sk2_const.ARC_CHORD,
	sk_const.ArcPieSlice:sk2_const.ARC_PIE_SLICE,
}

SK2_LINE_JOIN = {
	sk_const.JoinMiter:sk2_const.JOIN_MITER,
	sk_const.JoinRound:sk2_const.JOIN_ROUND,
	sk_const.JoinBevel:sk2_const.JOIN_BEVEL,
}

SK2_LINE_CAP = {
	sk_const.CapButt:sk2_const.CAP_BUTT,
	sk_const.CapRound:sk2_const.CAP_ROUND,
	sk_const.CapProjecting:sk2_const.CAP_SQUARE,
}

SK2_TEXT_ALIGN = {
	sk_const.ALIGN_LEFT:sk2_const.TEXT_ALIGN_LEFT,
	sk_const.ALIGN_RIGHT:sk2_const.TEXT_ALIGN_RIGHT,
	sk_const.ALIGN_CENTER:sk2_const.TEXT_ALIGN_CENTER,
}
...
SK_ARC_TYPES = {
	sk2_const.ARC_ARC:sk_const.ArcArc,
	sk2_const.ARC_CHORD:sk_const.ArcChord,
	sk2_const.ARC_PIE_SLICE:sk_const.ArcPieSlice,
}

SK_LINE_JOIN = {
	sk2_const.JOIN_MITER:sk_const.JoinMiter,
	sk2_const.JOIN_ROUND:sk_const.JoinRound,
	sk2_const.JOIN_BEVEL:sk_const.JoinBevel,
}

SK_LINE_CAP = {
	sk2_const.CAP_BUTT:sk_const.CapButt,
	sk2_const.CAP_ROUND:sk_const.CapRound,
	sk2_const.CAP_SQUARE:sk_const.CapProjecting,
}

SK_TEXT_ALIGN = {
	sk2_const.TEXT_ALIGN_LEFT:sk_const.ALIGN_LEFT,
	sk2_const.TEXT_ALIGN_RIGHT:sk_const.ALIGN_RIGHT,
	sk2_const.TEXT_ALIGN_CENTER:sk_const.ALIGN_CENTER,
	sk2_const.TEXT_ALIGN_JUSTIFY:sk_const.ALIGN_LEFT,
}
...
def get_sk_style(source_obj, cms):
	...
	if fill and fill[1] == sk2_const.FILL_SOLID:
		sk1_style.fill_pattern = sk_model.SolidPattern(get_sk_color(fill[2], cms))
	if stroke:
		sk1_style.line_pattern = sk_model.SolidPattern(get_sk_color(stroke[2], cms))
