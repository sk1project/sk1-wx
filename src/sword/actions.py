...
from sword.events import NO_DOCS, DOC_MODIFIED, \
    DOC_CHANGED, DOC_SAVED
...
def create_actions(app):
    ...
    entries = [
        ...
        ['BACKWARD', _('Go back'), _('Go back'), gtk.STOCK_GO_BACK,
         '<Alt>Left', proxy.backward_object,
        ...
        ['FORWARD', _('Go forward'), _('Go forward'), gtk.STOCK_GO_FORWARD,
         '<Alt>Right', proxy.forward_object,
         [events.NO_DOCS, events.DOC_CHANGED,
        ...
        ['CLEAR_HISTORY', _('Clear history'), _('Clear history'),
         ...
         insp.can_clear_history],

        ['REFRESH_OBJ', _('Refresh object'), _('Refresh object'),
         gtk.STOCK_REFRESH,
         '<Control>R', proxy.refresh_object,
         [events.NO_DOCS, events.DOC_CHANGED,
          events.SELECTION_CHANGED], insp.can_refresh_object],
        ['EDIT_OBJ', _('Edit binary chunk'), _('Edit binary chunk'),
         gtk.STOCK_EDIT,
         None, proxy.edit_object, [events.NO_DOCS, events.DOC_CHANGED,
                                   events.SELECTION_CHANGED],
         insp.can_edit_object],
        ['UPDATE_OBJ', _('Update edited chunk'), _('Update edited chunk'),
         gtk.STOCK_REVERT_TO_SAVED,
         None, proxy.update_object, [events.NO_DOCS, events.DOC_CHANGED,
                                     events.SELECTION_CHANGED],
         insp.can_update_object],

        ['REFRESH_MODEL', _('Refresh model'), _('Refresh model'),
         gtk.STOCK_REFRESH,
        ...
        ['REPORT_BUG', _('_Report bug'), _('Report bug'),
         gtk.STOCK_DIALOG_WARNING, None,
         proxy.report_bug, None, None],
        ['PROJECT_WEBSITE', _('Project _web site'), _('Project web site'), None,
         None,
