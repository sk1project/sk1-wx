...
GENERICS = [SK1_ICON16, SK1_ICON22, SK1_ICON32, SK1_ICON48, SK1_ICON64, SK1_ICON128,
		...
		ARROW_TOP, ARROW_BOTTOM, SLIDER_KNOB, REG_SIGN, PD_LARGE_SEL_PALETTE,
		PD_SMALL_SEL_PALETTE, PD_CAP_BUTT, PD_CAP_SQUARE, PD_CAP_ROUND,
		PD_JOIN_BEVEL, PD_JOIN_MITER, PD_JOIN_ROUND, PD_LINEAR_GRAD, PD_RADIAL_GRAD,
		SLIDER_STOP, SLIDER_KNOB_SEL, SLIDER_STOP_SEL,
		...
		ORIGIN_LU, L_ORIGIN_CENTER, L_ORIGIN_LL, L_ORIGIN_LU,
		...
		PD_POSITION_PLGN, PD_RESIZE_PLGN, PD_SCALE_PLGN, PD_ROTATE_PLGN, PD_SHEAR_PLGN,
		...
		PD_TEXT_BOLD, PD_TEXT_ITALIC, PD_TEXT_STRIKETHROUGH, PD_TEXT_SUBSCRIPT,
		PD_TEXT_SUPERSCRIPT, PD_TEXT_UNDERLINE, PD_TEXT_CAPITALIZE,
		PD_TEXT_LOWERCASE, PD_TEXT_UPPERCASE, PD_TEXT_CLEAR_MARKUP,
		PD_PRINT_COPIES_00, PD_PRINT_COPIES_10, PD_PRINT_COPIES_01, PD_PRINT_COPIES_11,
		PD_PRINTER_LASER, PD_PRINTER_INKJET, PD_PRINTMODE_MONO, PD_PRINTMODE_COLOR,
		PD_PRINTORIENT_PORTRAIT, PD_PRINTORIENT_LANDSCAPE,
