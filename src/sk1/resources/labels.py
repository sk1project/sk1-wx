...
pdids.ID_BEZIER_SEG_TO_LINE:(_('Convert segment to line'),),
pdids.ID_BEZIER_SEG_TO_CURVE:(_('Convert segment to curve'),),
pdids.ID_BEZIER_NODE_CUSP:(_('Cusp node'),),
pdids.ID_BEZIER_NODE_SMOOTH:(_('Smooth node'),),
pdids.ID_BEZIER_NODE_SYMMETRICAL:(_('Symmetrical node'),),
