...
class HPalette(HPanel):
    ...
    def dscroll_left(self):
        self.change_position(-self.screen_num)

    def dscroll_right(self):
        self.change_position(self.screen_num)
    ...
    def _on_move(self, event):
        ...
        self.mouse_screen_pos = event.GetEventObject().ClientToScreen(
            self.mouse_pos)
        self.SetFocus()
        self.set_tip()
...
class VPalette(VPanel):
    ...
    def dscroll_top(self):
        self.change_position(-self.screen_num)

    def dscroll_bottom(self):
        self.change_position(self.screen_num)
