...
class AppPaletteManager(PaletteManager):
	...
	def __init__(self, app):
		...
		self.set_palette(STD_RGB_PALETTE)
	...
	def init_builtin_palettes(self):
		...
		pal.model.comments = _('The palette has been converted from sK1 RGB palette.')
		...
		pal.model.comments = _('The palette has been inherited from Sketch application.')
